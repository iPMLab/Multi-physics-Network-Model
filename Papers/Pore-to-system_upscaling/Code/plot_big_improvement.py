...
import matplotlib
from Common_Vars import _Path_fig as Path_fig, plt, figsize_x, figsize_y
import addict
...
# 设置图表标题和标签
ax1.set_title("Original DNM", fontsize=14)
ax1.set_xlabel("Re\n(a)")
...
ax2.set_title("Calibrated DNM", fontsize=14)
ax2.set_xlabel("Re\n(b)")
...
ax1.set_ylim(bottom=0, top=0.38)
...
# 调整布局
plt.tight_layout()
plt.savefig(Path_fig / f"big_improvement_{prefix}.png")
# 显示图表
plt.show()
