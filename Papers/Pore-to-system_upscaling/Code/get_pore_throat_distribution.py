...
plt_pore_volume_void_dualn = []
plt_pore_volume_solid_dualn = []
...
for j, PARAM in enumerate(PARAMS):
    for i in range(len(Res)):
        ...
        plt_pore_P_dualn.append(dualn["pore.P"][dualn["pore.void"]])
        ...
        plt_pore_volume_void_dualn.append(dualn["pore.volume"][dualn["pore.void"]])
        ...
        plt_pore_volume_solid_dualn.append(dualn["pore.volume"][dualn["pore.solid"]])
...
plt_pore_volume_void_dualn = np.concatenate(plt_pore_volume_void_dualn)
plt_pore_volume_solid_dualn = np.concatenate(plt_pore_volume_solid_dualn)
...
output_pore = pd.DataFrame(
    ...
    columns=(
        ...
        "pore_T_void_comsol",
        "pore_T_void_dualn",
        "pore_volume_void_dualn",
        "pore_volume_solid_dualn",
    ),
)
output_throat.to_csv("plot_throat_N5.000_optimized.csv")
output_pore.to_csv("plot_pore_N5.000_optimized.csv")
